...
var $author$project$Main$photoArray = $elm$core$Array$fromList($author$project$Main$initialModel.photos);
...
var $author$project$Main$urlPrefix = 'https://elm-in-action.com/';
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_Utils_ap($author$project$Main$urlPrefix, thumb.url)),
					...
					$elm$html$Html$Events$onClick(
					$author$project$Main$ClickedPhoto(thumb.url))
				]),
			_List_Nil);
	});
